...
function Recepciones() {
    ...
    return (
        <>
            <h1 className="text-center text-bg-dark p-2">&mdash; Recepciones &mdash;</h1>
            <div className="d-flex justify-content-between">
                ...
                <div>
                    <button data-bs-toggle="modal" data-bs-target="#activarModal" type="button" className="btn btn-primary me-2 mt-2">+ Agregar recepción</button>
            ...
            <table className="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Cantidad de recepción</th>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="titleModalAgregar">&mdash; Agregar recepción &mdash;</h5>
                        ...
                        <div className="modal-body">
                            <form>
                                ...
                                <div className="mb-3">
                                    <label className="form-label">Cantidad de recepción:</label>
            ...
            <div className="modal fade" id="editarModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">&mdash; Editar recepción &mdash;</h5>
                        ...
                        <div className="modal-body">
                            <form>
                                ...
                                <div className="mb-3">
                                    <label className="form-label">Cantidad de recepción:</label>
                                    <input type="number" placeholder="Cantidad de recepción" className="form-control" id="txtCantidadEntrega"></input>
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">Proveedor:</label>
                                    <Select options={destinatarios.map((destinatario) => ({
            ...
            <div className="modal fade" id="desactivarModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">&mdash; ¿Deseas desactivar la recepción? &mdash;</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
            ...
            <div className="modal fade" id="activarModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">&mdash; ¿Deseas activar la recepción? &mdash;</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
