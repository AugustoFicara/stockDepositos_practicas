<?php
	class Respuesta { 
		...
		private $ErrorDescripcion = [
			...
			10 => ["Numero" => "448", "Descripción" => "Usuario con bono inexistente", "Codigo" => "1106", "Detalle"=>"Usuario con bono inexistente o numero de CUIT Erroneo"],
			...
			16 => ["Numero" => "1021", "Descripción" => "No hay conección a los relojes", "Codigo" => "1008", "Detalle"=>"No se puede conectar a los relojes"]
		];
